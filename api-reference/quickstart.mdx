    ...
    <Tab title="From Bitcoin">
        <Steps>
            ...
            <Step title="Submit Order">
                ...
                ```
                <Note>
                    Send 0.0005 BTC to tb1ptt49v22dcst7mquwfsmcu2t56xjg07whtcgufvhjuj5zu89y6q0qn8fvfp, you can use our [faucet](https://testnetbtc.com)
                </Note>
            </Step>
            <Step title="Check Order Status">
                ...
                ```bash Response expandable focus={46}
                {
                    "status": "Ok",
                    "result": {
                ...
                ```
                The swap is complete once the `order.destination_swap.redeem_tx_hash` is set
            </Step>
        </Steps>
    </Tab>
    <Tab title="From EVM">
        <Steps>
            ...
            <Step title="Check Order Status">
                ...
                ```
                Try it out [here](/api-reference/endpoint/orders/get-order-by-id?playground=true)
                ```bash Response expandable focus={45}
                {
                    "status": "Ok",
                    "result": {
        ...
        <Steps>
            ...
            <Step title="Check Order Status">
                Get the order by id to check the status of the swap.
                 ```bash wrap
                curl -X 'GET' \
                'https://testnet.api.garden.finance/v2/orders/dbf0f3037b720e3e07316481a07e29262200d185def0bfb8c834ccbe973b9ce3' \
                -H 'garden-app-id: f242ea49332293424c96c562a6ef575a819908c878134dcb4fce424dc84ec796' \
                -H 'accept: application/json'                
                ```
                Try it out [here](/api-reference/endpoint/orders/get-order-by-id?playground=true)
                ```bash Response expandable focus={45}
                {
                    "status": "Ok",
                    "result": {
                        "created_at": "2025-07-11T15:04:00.482486Z",
                        "source_swap": {
                            "created_at": "2025-07-11T15:04:00.482486Z",
                            "swap_id": "1d432a32c6f6ce6f63369c70a11510f3238509eaffaca90ebf5f99f7341b33a7",
                            ...
                            "asset_price": 166.76,
                            "amount": "354608265",
                            "secret_hash": "8f4496f0477e05038c0437ac28fc6bc1f7cd2c135d82e38ef9071c59f876c8f7",
                            "secret": "",
                            "initiate_tx_hash": "",
                            "redeem_tx_hash": "",
                            "refund_tx_hash": "",
                        ...
                        "destination_swap": {
                            "created_at": "2025-07-11T15:04:00.482486Z",
                            "swap_id": "tb1pdpjayzxgx4c9p6vz92rzztc0dw5hxydym5zmxwzmfequenh0zs8qyl7s69",
                            "chain": "bitcoin_testnet",
                            "asset": "bitcoin_testnet:btc",
                            "initiator": "460f2e8ff81fc4e0a8e6ce7796704e3829e3e3eedb8db9390bdc51f4f04cf0a6",
                            "redeemer": "tb1p4pr78swsn60y4ushe05v28mqpqppxxkfkxu2wun5jw6duc8unj3sjrh4gd",
                            "delegate": "24ad278f4ba845174fb42c3ef1a34ff1e8fc75a0f9123fb475ae481f7a76fe7a",
                            "timelock": 12,
                            "filled_amount": "0",
                            "asset_price": 166.76,
                            "amount": "49850",
