...
<Note>
If you get stuck during implementation, reach out in our [Townhall](https://discord.gg/B7RczEFuJ5)—our dev team is ready to help!
</Note>
...
If you need an API key, please reach out to us on [Townhall](https://discord.gg/B7RczEFuJ5) and ping us, or raise a support ticket.
...
<CardGroup cols={2}>
  <Card title="SDK integration" href="/developers/guides/sdk">
