...
<Note>
Refer to the [Supported assets](/developers/supported-chains) to find the asset addresses of USDC and cbBTC. Check out the full implementation using API [here](/developers/api/quickstart).
</Note>
...
<Note>
Check out full SDK implementation using Node.js [here](/developers/sdk/nodejs/quickstart).
</Note>
...
<Note>
Check out full SDK implementation using React [here](/developers/sdk/react/quickstart).
</Note> 