...
<Note>
Refer to the [Supported assets](/developers/supported-chains) to find the asset addresses of USDC and cbBTC. Check out the full implementation using API [here](/api/quickstart).
</Note>
...
<Note>
Check out full SDK implementation for [Node.js](/developers/sdk/nodejs/quickstart) or [React](/developers/sdk/react/quickstart) here.
</Note>