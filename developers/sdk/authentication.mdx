...
description: "Learn how to authenticate with Garden using API keys or Sign-In with Ethereum (SIWE)"
---

# Authentication

Garden supports two authentication methods:

<CardGroup cols={2}>
  <Card title="API Key Authentication" icon="key">
    Don't require users to sign messages repeatedly. Contact the Garden team to get an API key.
  </Card>
  <Card title="SIWE Authentication" icon="ethereum">
    Session-based, user-specific flows using Sign-In with Ethereum for wallet verification.
  </Card>
</CardGroup>
