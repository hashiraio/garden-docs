...
<Steps>
    ...
    <Step title="Setup your React app">
        ...
        <Note>
            The Starknet or Solana configuration is only necessary if you choose to support those chains in your app.
        </Note>
...
<Note>
  To include affiliate fees in your swap flow, refer to the implementation
  [here](/developers/affiliate-fees#react).
</Note>
