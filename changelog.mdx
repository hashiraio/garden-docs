...
<Update label="February 12, 2026" description="v2.5.3" tags={["SDK"]}>
  ### New chains
  - Added support for [BTC.b on megaETH](/developers/supported-chains).
  - Added testnet support for [USDC on HyperEVM](/developers/supported-chains).
</Update>
...
<Update label="January 12, 2026" description="v2.0.15" tags={["API"]}>
  ### Endpoint updates
  - Added [Tron and Litecoin](/developers/supported-chains) support.
