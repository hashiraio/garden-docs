...
<Update label="September 3, 2025" description="v2.0.2" tags={["API"]}>
  ### New endpoint
...
<Update label="July 30, 2025" description="v2.4.0" tags={["SDK"]}>
   - Add `handleSecretManagement` flag for optional secret management. When set to `false`, the relayer manages order redemption, eliminating the need for the user to keep the browser open after initiating a swap. When set to `true`, the user must handle secrets and keep the browser open until redemption is complete.
</Update>
