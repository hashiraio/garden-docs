...
<Update label="August 6, 2025" description="v2.0.2" tags={["API"]}>
  ### New endpoints
  
  - Add `/affiliates/earnings` endpoint for fetching affiliate earnings
  - Add `/affiliates/history` endpoint for fetching affiliate history
</Update>
