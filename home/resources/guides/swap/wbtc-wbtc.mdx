...
<CardGroup cols={2}>
  <Card title="BTC to WBTC" icon="bitcoin" href="/home/resources/guides/swap/btc-wbtc">
    Wrap Bitcoin to get WBTC for cross-chain transfers
  </Card>
  <Card title="WBTC to BTC" icon="arrows-rotate" href="/home/resources/guides/swap/wbtc-btc">
...
- **Discord Support**: Join our [community](https://discord.gg/B7RczEFuJ5) for assistance
- **Technical Issues**: Reach out for [support on Discord](https://discord.gg/B7RczEFuJ5)
